...
function Navbar() {
  return (
    <>
      <div className="w-60 pr-6 flex justify-start flex-col items-start bg-white h-screen  border-r">
        {/* <img className="pl-7 pt-10 w-28 h-24" src={logo} alt="logo" /> */}
        <svg
          aria-label="Instagram"
          className="ml-10 pt-2 w-28 h-24"
          color="black"
